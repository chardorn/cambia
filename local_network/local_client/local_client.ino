...
const char* ssid[] = {"pink pants cricket", "Gil's hotspot"};
const char* pass[] = {"breezyshrub", "breezyshrub"};
int num_networks;

const char* local_ssid = "NETGEAR98";
const char* local_pass = "breezyshrub511";
